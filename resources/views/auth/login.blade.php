                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mx-auto">
                    <div class="card rounded-4 mb-0 border-top border-4 border-primary border-gradient-1">
                        <div class="card-body p-5">
                            ...
                            {{-- Dynamic logo (configurable in config/app.php or .env) --}}
                            ...
                            <div class="d-flex gap-3 justify-content-center mt-4">
                                ...
                                {{-- <a href="{{ url('/auth/facebook') }}" class="wh-42 d-flex align-items-center justify-content-center rounded-circle bg-grd-deep-blue">
                                    <i class="bi bi-facebook fs-5 text-white"></i>
                                </a>
                                <a href="{{ url('/auth/linkedin') }}" class="wh-42 d-flex align-items-center justify-content-center rounded-circle bg-grd-info">
                                    <i class="bi bi-linkedin fs-5 text-white"></i>
                                </a>
                                <a href="{{ url('/auth/github') }}" class="wh-42 d-flex align-items-center justify-content-center rounded-circle bg-grd-royal">
