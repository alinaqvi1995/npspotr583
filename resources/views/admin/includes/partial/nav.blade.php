                        ...
                        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3 g-4 g-lg-5">
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/02.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Website</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/03.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Subscribers</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/01.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Hubspot</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/11.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Templates</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/13.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Ebooks</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/12.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Sales</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/08.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Tools</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                            ...
                            <div class="col">
                                <div class="card rounded-4 shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start gap-3">
                                            <img src="{% static 'images/megaIcons/09.png' %}" width="40"
                                                alt="">
                                            <div class="mega-menu-content">
                                                <h5>Academy</h5>
                                                <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is a
                    ...
                    <div class="border rounded-4 overflow-hidden">
                        <div class="row row-cols-3 g-0 border-bottom">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/01.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/02.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/03.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                        ...
                        <div class="row row-cols-3 g-0 border-bottom">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/04.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/05.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/06.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                        ...
                        <div class="row row-cols-3 g-0 border-bottom">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/07.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/08.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/09.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                        ...
                        <div class="row row-cols-3 g-0">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/10.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/11.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{% static 'images/apps/12.png' %}" width="36" alt="">
                                    </div>
                                    <div class="app-name">
