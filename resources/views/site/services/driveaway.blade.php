...
@section('title', 'Driveaway Service – Bridgeway Logistics LLC')
@section('meta_description', 'Driveaway services by Bridgeway Logistics LLC – professional drivers to relocate your vehicles quickly and safely.')
@section('meta_keywords', 'driveaway service, professional drivers USA, vehicle relocation, logistics, Bridgeway Logistics')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        <h1 class="breadcrumb-title text-center">Driveaway Service</h1>
                ...
                <div class="col-lg-6" data-sal="slide-left" data-sal-duration="800">
                    <div class="about-content-three">
                        <div class="tj-section-heading">
                            <span class="sub-title active-shape">Professional Vehicle Relocation</span>
                            <h2 class="title">Driveaway Service</h2>
                            <p class="desc">
                                Our Driveaway Service provides licensed drivers to deliver your vehicle directly to its destination—fast, safe, and efficient.
                            </p>
                        </div>
                        <div class="content-box d-flex align-items-center">
                            <div class="tj-icon-box">
                                <div class="ab-text d-flex align-items-center">
                                    <div class="ab-icon"><img src="web-assets/images/icon/global.svg" alt="Experienced Drivers" /></div>
                                    <div class="ab-title"><h5 class="title">Experienced Drivers</h5></div>
                                </div>
                                <p class="desc">Our drivers are fully licensed and trained for long-haul and specialized vehicles.</p>
                            </div>
                            <div class="tj-icon-box">
                                <div class="ab-text d-flex align-items-center">
                                    <div class="ab-icon"><img src="web-assets/images/icon/winner.svg" alt="On-Time Delivery" /></div>
                                    <div class="ab-title"><h5 class="title">On-Time Delivery</h5></div>
                                </div>
                                <p class="desc">We guarantee punctual delivery, keeping your schedule on track.</p>
                            </div>
                        </div>
                        <div class="tj-theme-button">
                            <a class="tj-primary-btn" href="{{ route('contact') }}">
                                Hire a Driver <i class="flaticon-right-1"></i>
                            </a>
                        </div>
                    </div>
                </div>
