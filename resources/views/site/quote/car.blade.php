            ...
            <div class="row">
                ...
                <div class="col-lg-8" data-sal="slide-down" data-sal-duration="800">
                    <div class="tj-input-form w-auto" data-bg-image="">
                        ...
                        <form action="#" method="post" class="rd-mailform validate-form"
                                        ...
                                        <div class="input-form tj-select model-div">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu model-dropdown" aria-labelledby="model">
                                                    ...
                                                    <li><a class="dropdown-item" data-value="Model S" href="#">Model S</a></li>
                                                    <li><a class="dropdown-item" data-value="Model 3" href="#">Model 3</a></li>
                                                    <li><a class="dropdown-item" data-value="Model X" href="#">Model X</a></li>
                                                    <li><a class="dropdown-item" data-value="Model Y" href="#">Model Y</a></li>
