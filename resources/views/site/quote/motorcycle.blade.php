                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        ...
                        <div class="breadcrumb-link">
                            <span><a href="#"><span>Home</span></a></span> > <span><span> Vehicle -
                                    Motorcycle</span></span>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <form action="{{ route('frontend.submit.quote') }}" method="post"
                                            class="rd-mailform validate-form" id="calculatePriceFrom" novalidate
                                            ...
                                            <div class="tabs-form-box">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="tabs-input position-relative">
                                                                ...
                                                                <div id="delivery-suggestions" class="suggestions-box">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- Vehicle Info -->
                                                <div class="tabs-form-box">
                                                    <h6 class="title">Motorcycle Information</h6>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="tabs-input">
                                                                <select name="vehicles[0][year]" required>
                                                                    <option value="">-- Select Year --</option>
                                                                    @for ($year = $currentYear; $year >= $startYear; $year--)
                                                                        <option value="{{ $year }}"
                                                                            {{ old('vehicles.0.year') == $year ? 'selected' : '' }}>
                                                                            {{ $year }}
                                                                        </option>
                                                                    @endfor
                                                                </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="tabs-input">
                                                                <input type="text" name="vehicles[0][make]"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="tabs-input">
                                                                <input type="text" name="vehicles[0][model]"
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="form-control" name="vehicles[0][condition]">
                                                                <option value="Running"
                                                                    {{ old('vehicles.0.condition') == 'Running' ? 'selected' : '' }}>
                                                                    Running</option>
                                                                <option value="Non-Running"
                                                                    {{ old('vehicles.0.condition') == 'Non-Running' ? 'selected' : '' }}>
                                                                    Non-Running</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- Vehicle Images -->
                                                    <div class="mt-2">
                                                        <input class="form-control image_input" name="images[0][]"
                                                ...
                                                <div class="tabs-form-box">
                                                    <div class="row mt-2">
                                                        <div class="col-md-6">
                                                            <label>
                                                                <input type="checkbox" name="modified" value="1"
                                                                    {{ old('modified') ? 'checked' : '' }}>
                                                                Modified?
                                                            </label>
                                                            <div class="mt-2"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mt-2"
                                                                ...
                                                                <input class="form-control" type="url"
                                                                    name="available_link" placeholder="Auction Link"
                                                                    value="{{ old('available_link') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
