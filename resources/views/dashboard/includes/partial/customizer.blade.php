...
<div class="maxton-sidebar">
    ...
    <div class="maxton-sidebar__wrapper">
        ...
        <nav class="maxton-sidebar__menu-wrapper">
            <ul class="maxton-sidebar__menu">
                <li class="maxton-sidebar__menu__item has-children">
                    <a href="#" class="maxton-sidebar__menu__link">
                    ...
                    <ul class="maxton-sidebar__submenu">
                        <li class="maxton-sidebar__menu__item">
                            <a href="/" class="maxton-sidebar__menu__link">Server Management</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="index-2" class="maxton-sidebar__menu__link">Banking</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="index-3" class="maxton-sidebar__menu__link">Crypto</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="index-4" class="maxton-sidebar__menu__link">Invoicing</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="maxton-sidebar__menu__item has-children">
                    ...
                    <ul class="maxton-sidebar__submenu">
                        <li class="maxton-sidebar__menu__item">
                            <a href="#" class="maxton-sidebar__menu__link maxton-customizer__btn--top">Top Menu</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="#" class="maxton-sidebar__menu__link maxton-customizer__btn--side">Side
                                Menu</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="#" class="maxton-sidebar__menu__link maxton-customizer__btn--light">Light
                                Demo</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="#" class="maxton-sidebar__menu__link maxton-customizer__btn--dark">Dark
                                Demo</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="#" class="maxton-sidebar__menu__link maxton-customizer__btn--ltr">LTR Demo</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="#" class="maxton-sidebar__menu__link maxton-customizer__btn--rtl">RTL Demo</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="maxton-sidebar__menu__item has-children">
                    ...
                    <ul class="maxton-sidebar__submenu">
                        <li class="maxton-sidebar__menu__item">
                            <a href="todo" class="maxton-sidebar__menu__link">Todo</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="chat" class="maxton-sidebar__menu__link">Chat</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="calendar" class="maxton-sidebar__menu__link">Calendar</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="file-manager" class="maxton-sidebar__menu__link">File Manager</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="contact" class="maxton-sidebar__menu__link">Contact</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="kanban" class="maxton-sidebar__menu__link">Kanban</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="maxton-sidebar__menu__item has-children">
                    ...
                    <ul class="maxton-sidebar__submenu">
                        <li class="maxton-sidebar__menu__item">
                            <a href="chart" class="maxton-sidebar__menu__link">Chart</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="badge" class="maxton-sidebar__menu__link">Badge</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="button" class="maxton-sidebar__menu__link">Button</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="color" class="maxton-sidebar__menu__link">Color</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="table" class="maxton-sidebar__menu__link">Table</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="form" class="maxton-sidebar__menu__link">Form</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="icon" class="maxton-sidebar__menu__link">Icon</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="navigation" class="maxton-sidebar__menu__link">Navigation</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="typography" class="maxton-sidebar__menu__link">Typography</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="maxton-sidebar__menu__item has-children">
                    ...
                    <ul class="maxton-sidebar__submenu">
                        <li class="maxton-sidebar__menu__item">
                            <a href="blog" class="maxton-sidebar__menu__link">Blog</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="faq" class="maxton-sidebar__menu__link">Faq</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="pricing" class="maxton-sidebar__menu__link">Pricing</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="testimonial" class="maxton-sidebar__menu__link">Testimonial</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="terms" class="maxton-sidebar__menu__link">Terms & Conditions</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="signin" class="maxton-sidebar__menu__link">Sign In</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="signup" class="maxton-sidebar__menu__link">Sign Up</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="forgot-password" class="maxton-sidebar__menu__link">Forget Password</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="verification" class="maxton-sidebar__menu__link">Two Step
                                Verification</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="error" class="maxton-sidebar__menu__link">Error</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="coming-soon" class="maxton-sidebar__menu__link">Coming Soon</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="maintenance" class="maxton-sidebar__menu__link">Maintenance</a>
                        </li>
                        <li class="maxton-sidebar__menu__item">
                            <a href="blank" class="maxton-sidebar__menu__link">Blank Page</a>
                        </li>
                    </ul>
                </li>
            </ul>
        </nav>
        <div class="maxton-sidebar__footer">
            <span class="maxton-sidebar__footer__title">maxton Modern Dashboard</span>
            <p class="maxton-sidebar__footer__copyright">© 2024 All Rights Reserved</p>
            <p class="maxton-sidebar__footer__author">Made with <span class="heart-icon">♥</span> by <a
                    href="#">ThemeWant</a></p>
        </div>
    </div>
</div>