                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title rounded-circle bg-transparent">
                                                        <img src="admin-assets/images/users/48/avatar-2.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="border border-light-subtle px-3 py-2 rounded">
                                            <div class="d-flex gap-3">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title rounded-circle bg-transparent">
                                                        <img src="admin-assets/images/users/48/avatar-3.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <li>
                                        ...
                                        <div class="border border-light-subtle px-3 py-2 rounded">
                                            <div class="d-flex gap-3">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title rounded-circle bg-transparent">
                                                        <img src="admin-assets/images/users/48/avatar-4.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <li>
                                        ...
                                        <div class="border border-light-subtle px-3 py-2 rounded">
                                            <div class="d-flex gap-3">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title rounded-circle bg-transparent">
                                                        <img src="admin-assets/images/users/48/avatar-5.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <li>
                                        ...
                                        <div class="border border-light-subtle px-3 py-2 rounded">
                                            <div class="d-flex gap-3">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title rounded-circle bg-transparent">
                                                        <img src="admin-assets/images/users/48/avatar-7.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body vstack gap-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-xs flex-shrink-0">
                                            <div class="avatar-title bg-transparent">
                                                <img src="admin-assets/images/doctor/user-1.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-xs flex-shrink-0">
                                            <div class="avatar-title bg-transparent">
                                                <img src="admin-assets/images/doctor/user-2.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-xs flex-shrink-0">
                                            <div class="avatar-title bg-transparent">
                                                <img src="admin-assets/images/doctor/user-3.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-xs flex-shrink-0">
                                            <div class="avatar-title bg-transparent">
                                                <img src="admin-assets/images/doctor/user-4.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-xs flex-shrink-0">
                                            <div class="avatar-title bg-transparent">
                                                <img src="admin-assets/images/doctor/user-5.jpg" alt="" class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
