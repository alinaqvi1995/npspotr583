...
@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <!-- Form Title -->
            <h5 class="text-center fw-semibold mb-4">Order Form - Quote #{{ $orderForm->quote->id }}</h4>
                        ...
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Phone:</strong>
                                    @forelse ($orderForm->quote->pickupPhones as $row)
                                        <span class="badge bg-secondary me-1">{{ $row->phone }}</span>
                                    @empty
                                        -
                                    @endforelse
                                </p>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Phone:</strong>
                                    @forelse ($orderForm->quote->deliveryPhones as $row)
                                        <span class="badge bg-secondary me-1">{{ $row->phone }}</span>
                                    @empty
                                        -
                                    @endforelse
