                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label class="form-label">Location Name</label>
                                        <input type="text" name="locations[{{ $i }}][name]"
                                            class="form-control" placeholder="Type location name">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Location Type</label>
                                        <select name="locations[{{ $i }}][type]" class="form-select">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="locations[{{ $i }}][twic]" id="twic{{ $i }}">
                                            <label class="form-check-label" for="twic{{ $i }}">TWIC Card
                                                Required?</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="locations[{{ $i }}][save]" id="save{{ $i }}">
                                            <label class="form-check-label" for="save{{ $i }}">Save to Address
                                                Book</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="vehiclesContainer">
                            <div class="vehicle-item mb-3" data-index="1">
                                <div class="row g-3 vehicle-row">
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Make *</label>
                                        <select name="vehicles[1][make]" class="form-select make-select">
                                            <option value="">-- Select Make --</option>
                                            @foreach ($makes as $make)
                                                <option value="{{ $make }}">{{ $make }}</option>
                                            @endforeach
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Model *</label>
                                        <select name="vehicles[1][model]" class="form-select model-select">
                                            <option value="">-- Select Model --</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" name="dates[expiration_date]"
                                    value="{{ old('dates.expiration_date', now()->addDays(30)->format('Y-m-d')) }}">
                                <small class="text-muted">Select up to 30 days from your creation date</small>
                            </div>
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Desired Delivery Date</label>
                                <input type="number" class="form-control" name="pricing[amount]"
    ...
    <script>
        $(document).ready(function() {
            ...
            function populateYears($select) {
                $select.html('<option value="">-- Year --</option>');
            ...
            $('#addVehicleBtn').click(function() {
                vehicleIndex++;
                const $clone = $('#vehiclesContainer .vehicle-item').first().clone();
                $clone.attr('data-index', vehicleIndex);
                $clone.find('input, select').each(function() {
                    const newName = $(this).attr('name').replace(/\d+/, vehicleIndex);
                    $(this).attr('name', newName).val('');
                });
                populateYears($clone.find('.year-select'));
                $clone.find('.text-end').html(
                    '<button type="button" class="btn btn-outline-danger deleteVehicleBtn">Delete</button>'
                );
                $('#vehiclesContainer').append($clone);
            });
            ...
            $(document).on('click', '.addPhoneBtn', function(e) {
                e.preventDefault();
                $(this).closest('.col-md-6').find('.phone-container').append(
                    '<input type="text" name="extra_phone[]" class="form-control mt-1" placeholder="Additional Phone">'
                );
            });
        });
    </script>
