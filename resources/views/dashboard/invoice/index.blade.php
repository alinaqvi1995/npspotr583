                        ...
                        <div class="download-inner" id="download_section">
                                ...
                                <div class="row align-items-center justify-content-end">
                                    <div class="col-auto">
                                        <div class="header-logo">
                                            <a href="index.html"><img src="{{ asset('web-assets/images/logo/logo_001.png') }}" alt="Invar"></a>
                                        </div>
                                    </div>
                                </div>
                            </header>
                            <div class="row justify-content-between mb-30 mt-5 pt-4">
                                <div class="col-auto">
                                    <div class="invoice-left">
                                        <b>From:</b>
                                        <address>
                                            <b>Bridgeway Logistics LLC</b><br>
                                            123 Main Street<br>
                                            Houston, TX 77001<br>
                                ...
                                <div class="col-auto">
                                    <div class="invoice-right">
                                        ...
                                        <p class="invoice-number"><b>Invoice No:</b> #INV-2025-0823</p>
                            ...
                            <table class="invoice-table style2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>01</td>
                                        <td>Car Transport (Houston to Dallas)<br><small>Safe and insured door-to-door vehicle shipping.</small></td>
                                        <td>$650.00</td>
                                        <td>1</td>
                                        <td>$650.00</td>
                                    </tr>
                                    <tr>
                                        <td>02</td>
                                        <td>Motorcycle Transport<br><small>Specialized trailer shipping for motorcycles.</small></td>
                                        <td>$400.00</td>
                                        <td>1</td>
                                        <td>$400.00</td>
                                    </tr>
                                    <tr>
                                        <td>03</td>
                                        <td>Heavy Equipment Transport<br><small>Secure and professional handling of construction equipment.</small></td>
                                        <td>$1,200.00</td>
                                        <td>1</td>
                                        <td>$1,200.00</td>
                                    </tr>
