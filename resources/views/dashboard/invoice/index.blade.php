                        ...
                        <div class="row justify-content-between mb-30 mt-5 pt-4">
                            <div class="col-4">
                                <div class="invoice-left">
                                    <b>From:</b>
                                    <address>
                                        {{ $quote->pickupLocation?->name ?? '-' }}<br>
                                        {{ $quote->pickupLocation?->address1 ?? '-' }}<br>
                                        {{ $quote->pickupLocation?->full_location ?? '-' }}<br>
                                        {{-- Phone: {{ $quote->pickupLocation?->phones[0]->phone ?? '-' }}<br>
                                        Email: {{ $quote->pickupLocation?->contact_email ?? '-' }} --}}
                                    </address>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="invoice-left">
                                    <b>To:</b>
                                    <address>
                                        {{ $quote->deliveryLocation?->name ?? '-' }}<br>
                                        {{ $quote->deliveryLocation?->address1 ?? '-' }}<br>
                                        {{ $quote->deliveryLocation?->full_location ?? '-' }}<br>
                                        {{-- Phone: {{ $quote->deliveryLocation?->phones[0]->phone ?? '-' }}<br>
                                        Email: {{ $quote->deliveryLocation?->contact_email ?? '-' }} --}}
                                    </address>
                                </div>
                            </div>
                        ...
                        <table class="invoice-table style2">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th>Rate</th> --}}
                                    {{-- <th>Units</th> --}}
                                    {{-- <th class="text-nowrap">Line Total</th> --}}
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                ...
                                <div class="invoice-left">
                                    ...
                                    <p class="mb-0">Authoritatively envisioned business action <br> items through
                                        parallel.<br>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="footer-info">
                            <p class="mb-2">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <rect width="20" height="20" rx="4" fill="#fd5523" />
                                    <path
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_384_4" x1="9.99996" y1="14.9999" x2="9.99996"
                                            y2="4.99955" gradientUnits="userSpaceOnUse">
                            ...
                            <p class="mb-0">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_384_5" x1="9.99996" y1="14.9999" x2="9.99996"
                                            y2="4.99955" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#21171F" />
                                            <stop offset="1" stop-color="#3E4049" />
                                        </linearGradient>
                                ...
                                quote@bridgewaylogisticsllc.com
                            </p>
                        </div>
                    </div>
                    <div class="body-shape1">
                        <img src="{{ asset('invoice-assets/img/template/1.png') }}" alt="shape">
                    </div>
                    <div class="body-shape2">
                        <img src="{{ asset('invoice-assets/img/template/2.png') }}" alt="shape">
                    </div>
