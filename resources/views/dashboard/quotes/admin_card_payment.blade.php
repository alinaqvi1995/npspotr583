...
<style>
    ...
    #quoteInfo .info-item { flex: 1; min-width: 180px; }
    #quoteInfo .info-label { font-size: 0.78rem; text-transform: uppercase; color: #6b7280; font-weight: 600; }
    #quoteInfo .info-value { font-size: 0.95rem; font-weight: 700; color: #111827; }
    .charge-summary {
    ...
    .charge-summary .label { font-size: 0.82rem; opacity: 0.8; }
    .charge-summary .value { font-size: 1.1rem; font-weight: 700; }
    #adminPayForm { display: none; }
    .btn-charge {
        background: linear-gradient(135deg, #10b981, #059669);
        color: #fff;
        border: none;
    ...
    .btn-charge:hover { opacity: 0.9; transform: translateY(-1px); }
    .btn-charge:disabled { opacity: 0.6; transform: none; cursor: not-allowed; }
    .vehicle-pill {
        display: inline-block;
        background: #e0e7ff;
        color: #3730a3;
    ...
    <form id="adminCardForm" method="POST" action="{{ route('admin.quotes.cardPayment.charge') }}">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="pickup_address1" id="f_pickup_address" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">City, State, Zip <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="pickup_city_state_zip" id="f_pickup_city_state_zip" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Contact Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="pickup_contact_name" id="f_pickup_contact_name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Contact Email</label>
                        <input type="email" class="form-control" name="pickup_contact_email" id="f_pickup_contact_email">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Pickup Date <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" name="pickup_date" id="f_pickup_date" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <h6 class="fw-semibold text-primary mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Address <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="delivery_address1" id="f_delivery_address" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">City, State, Zip <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="delivery_city_state_zip" id="f_delivery_city_state_zip" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Contact Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="delivery_contact_name" id="f_delivery_contact_name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Contact Email</label>
                        <input type="email" class="form-control" name="delivery_contact_email" id="f_delivery_contact_email">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-section">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Amount to Charge ($) <span class="text-danger">*</span></label>
                    <div class="input-group">
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-5">
                    <label class="form-label fw-semibold">Authorized By (Name) <span class="text-danger">*</span></label>
